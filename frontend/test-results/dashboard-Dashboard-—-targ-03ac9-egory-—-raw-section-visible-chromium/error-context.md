...
- Name: dashboard.spec.ts >> Dashboard — targets >> groups targets by category — raw section visible
...
Locator: getByRole('heading', { name: /raw/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /raw/i })
