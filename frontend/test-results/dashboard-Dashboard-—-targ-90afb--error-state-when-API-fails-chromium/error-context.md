...
- Name: dashboard.spec.ts >> Dashboard — targets >> shows error state when API fails
- Location: e2e/dashboard.spec.ts:62:3
...
Call log:
  ...
  - waiting for getByText(/failed/i)
