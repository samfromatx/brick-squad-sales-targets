...
- Name: dashboard.spec.ts >> Dashboard — targets >> groups targets by category — graded section visible
...
Locator: getByRole('heading', { name: /graded/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /graded/i })
