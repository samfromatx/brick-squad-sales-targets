...
export async function mockApi(page: Page, overrides: Record<string, unknown> = {}) {
  const routes: Record<string, unknown> = {
    ...
    '**/api/v1/trends/search**': [{ card: 'Mahomes 2017 Prizm', sport: 'football' }],
    '**/api/v1/trends/detail**': {
      verdict: 'Buy PSA 9',
      market_confidence: 'Medium',
      primary_reason: 'Stable market with positive trend',
      buy_target: null,
      market_health: {
        trend: { direction: 'Stable', ratio: null, source_grade: null, source_window: null },
        volume: { signal: 'Stable', change_pct: null },
        liquidity: { label: 'Liquid', total_90d_sales: 25 },
        volatility: { label: 'Low', ratio: null },
      },
      ev_model: null,
